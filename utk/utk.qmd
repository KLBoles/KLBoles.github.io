...
> "the intersections of space, power, and knowledge in order to expose geographies that perpetuate or disrupt inequities in both processes and outcomes" (p. 4). [^2]
...
![](images/teacher-brain-learning.png){fig-alt="Picture of a teacher with a brain superimposed showing lots of thinking and ideas" height="360px" .fragment}<br> [[**Keystone**]{.purple}<br>Teacher STEM Learning]{.fragment}
:::
...
<div class="page-center">
<div class="custom-subtitle">**THREE STUDIES:<br>**</div></div>
---